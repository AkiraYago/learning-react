...
const Hooks = () => {
  ...
  return (
    <div className="concept-container">
      ...
      <p>Los <code>Hooks</code> son funciones proporcionadas por React que permiten diferentes cosas, como controlar estados, efectos, etc. Todo esto dentro de los componentes que hayamos creado.</p>
      ...
      <p>Aquí es donde entran los <code>Hooks</code>, los cuales serán usados para gestionar diferentes cosas dentro de cada habitación.</p>
      <h3 className="subtitle">Bloque de Código</h3>
      <p>Ejemplo de código mostrando algunos <code>Hooks</code> con los que cuenta React y su forma de uso:</p>
